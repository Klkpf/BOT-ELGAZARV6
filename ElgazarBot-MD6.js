...
"قد جربت تبكي فرح؟ وليش؟ ",
  ...
  "هل انت حرامي تويت بتعت إسلام حسن؟ ",
...
case 'الغباء': {
            ...
            break
case 'بوت': {
            	let lowq = `*عايز اي يبن المره العرص🤺:*\n*${runtime(process.uptime())}*`
                let buttons = [{ buttonId: 'menu', buttonText: { displayText: 'اختار اوامر' }, type: 1 }]
...
⋆ يمكنك التواصل مع المبرمج عبر التيلجرام ⤌⤈
 http://t.me/eslamboho
تبعني عبر اليوتيوب ⤌⤈
https://chat.whatsapp.com/BanFVzHhZa2HZhXCwtvDDn
...
ꔹ━━━━━ꔹ
( .اذاعه )
♚ بيعمل شير لكل الجروبات في البوت
ꔹ━━━━━ꔹ
( .جلب )
♚ يجلب لك ملفات سكريبت جيثب 
𓍹——————————𓍻
